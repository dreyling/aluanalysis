...
print data['rms98_norm']

if sys.argv[2] == 'quad':
  data['rms98_norm'] = np.power(data['rms98_norm'], 2)
elif sys.argv[2] == 'sqrt':
  data['rms98_norm'] = np.sqrt(data['rms98_norm'])
else:
  print "no scaling of y-values..."
...
nameSave =  "output/" + sys.argv[1][5:-4] + str(".pdf") 
