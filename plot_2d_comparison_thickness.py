...
############################################
# output names
title_save = 'compare_' + arguments['--results'][20:-4] + '_vs_thickness'
...
ax2.set_xlabel(r'x-projection, thickness [mm]')
ax2.set_ylabel(r'slope along axis [mrad/mm]')
ax4.set_xlabel(r'y-projection, thickness [mm]')
