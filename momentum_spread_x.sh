...
python plot_width_binned.py --configuration=measurement_binned.yaml --energy=all --thickness=1.0 --results=data/stats_and_fits_measurement_binned_data-fraction_0.9.npy  --width=gauss_si_norm
